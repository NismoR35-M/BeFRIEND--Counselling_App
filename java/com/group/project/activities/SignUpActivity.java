...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        user.put(Constants.KEY_USERNAME,binding.txtUsername.getText().toString());
        user.put(Constants.KEY_EMAIL,binding.txtEmail.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_USERNAME, binding.txtUsername.getText().toString());
    ...
    private Boolean isValidSignUpDetails() {
        if (encodedImage == null) {
            ...
            return false;
        } else if (binding.confirmPassEt.getText().toString().trim().isEmpty()) {
            showToast("Confirm password");
            return false;
        } else if (!binding.txtPassword.getText().toString().trim().equals(binding.confirmPassEt.getText().toString()
                .trim())) {
            showToast("Password and confirm password not matching");
            return false;
        } else {
            return true;
        }
