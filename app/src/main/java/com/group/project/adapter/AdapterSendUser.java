...
import com.group.project.user.ChatActivity;
...
public class AdapterSendUser extends RecyclerView.Adapter<AdapterSendUser.MyHolder>{
    ...
    public AdapterSendUser(Context context, List<UserModel> createModels) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            hashMap.put("msg", SendToActivity.getUri());
            hashMap.put("isSeen", false);
            hashMap.put("timestamp", ""+System.currentTimeMillis());
            hashMap.put("type", SendToActivity.getType());
            ...
            FirebaseFirestore.getInstance().collection("users").document(FirebaseAuth.getInstance().getCurrentUser().getUid()).addSnapshotListener((value, error) -> {
                ...
                if (notify){
                    sendNotification(createModels.get(position).getId(), Objects.requireNonNull(value.get("name")).toString(), " has sent "+SendToActivity.getType());
                }
                notify = false;
        ...
        holder.itemView.setOnLongClickListener(view -> {
            ...
            intent.putExtra("id", createModels.get(position).getId());
