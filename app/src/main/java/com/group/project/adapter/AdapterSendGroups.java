...
public class AdapterSendGroups extends RecyclerView.Adapter<AdapterSendGroups.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            FirebaseDatabase.getInstance().getReference("Groups").child(modelChatListGroups.getTimestamp()).child("Message").child(stamp)
                    .setValue(hashMap);
                    ...
                    FirebaseDatabase.getInstance().getReference("Groups").child(modelChatListGroups.getTimestamp()).child("Participants").addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            for (DataSnapshot ds : snapshot.getChildren()){
                                sendNotification(ds.getKey(), Objects.requireNonNull(user).getName(), " has sent "+SendToActivity.getType());
                            }
                        }
